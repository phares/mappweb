...
class OrderStoreReceivedSerializer(serializers.ModelSerializer):
    items = OrderItemSerializer(many=True, read_only=True)
    address = AddressSerializer(many=False, read_only=True)
    transporter = TransporterSerializer(many=False, read_only=True)
    store = StoreSerializer(many=False, read_only=True)
...
class OrderStoreProcessingSerializer(serializers.ModelSerializer):
    items = OrderItemSerializer(many=True, read_only=True)
    address = AddressSerializer(many=False, read_only=True)
    transporter = TransporterSerializer(many=False, read_only=True)
    store = StoreSerializer(many=False, read_only=True)
...
class OrderStoreCompleteSerializer(serializers.ModelSerializer):
    items = OrderItemSerializer(many=True, read_only=True)
    address = AddressSerializer(many=False, read_only=True)
    transporter = TransporterSerializer(many=False, read_only=True)
    store = StoreSerializer(many=False, read_only=True)
