...
def api_root(request, format=None):
    return Response({
        ...
        'Store orders received': reverse('ordersstorereceived-list', request=request, format=format),
        'Store orders processing': reverse('ordersstoreprocessing-list', request=request, format=format),
        'Store orders completed': reverse('ordersstorecomplete-list', request=request, format=format),
